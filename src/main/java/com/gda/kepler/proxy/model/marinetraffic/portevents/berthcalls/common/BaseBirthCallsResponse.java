package com.gda.kepler.proxy.model.marinetraffic.portevents.berthcalls.common;
...
@Schema(description = "schema.port_events.berth_calls.base.description")
public class BaseBirthCallsResponse {
    /**
     * A uniquely assigned ID by MarineTraffic for the subject vessel
     */
    @Schema(description = "property.SHIP_ID.description", example = "5567750")
     ...
     */
    @Schema(description = "property.MMSI.description", example = "237710500")
    @JsonProperty("MMSI")
    private String mmsi;
     ...
     */
    @Schema(description = "property.DOCK_TIMESTAMP_LT.description", example = "2020-10-20T06:22:00.000Z")
     ...
     */
    @Schema(description = "property.DOCK_TIMESTAMP_UTC.description", example = "2020-10-20T03:22:00.000Z")
     ...
     */
    @Schema(description = "property.DOCK_TIMESTAMP_OFFSET.description", example = "3.000000")
     ...
     */
    @Schema(description = "property.UNDOCK_TIMESTAMP_LT.description", example = "2020-10-20T06:45:00.000Z")
     ...
     */
    @Schema(description = "property.UNDOCK_TIMESTAMP_UTC.description", example = "2020-10-20T03:45:00.000Z")
     ...
     */
    @Schema(description = "property.UNDOCK_TIMESTAMP_OFFSET.description", example = "3.000000")
     ...
     */
    @Schema(description = "property.SHIPNAME.description", example = "PILOT BOAT PY56")
     ...
     */
    @Schema(description = "property.SHIPTYPE.description", example = "Pilot Vessel")
     ...
     */
    @Schema(description = "property.DWT.description")
    @JsonProperty("DWT")
    private String dwt;
     ...
     */
    @Schema(description = "property.GRT.description")
    @JsonProperty("GRT")
    private String grt;
     ...
     */
    @Schema(description = "property.YEAR_BUILT.description")
     ...
     */
    @Schema(description = "property.BERTH_ID.description", example = "6")
     ...
     */
    @Schema(description = "property.BERTH_NAME.description", example = "Container Terminal")
     ...
     */
    @Schema(description = "property.TERMINAL_ID.description", example = "978")
     ...
     */
    @Schema(description = "property.TERMINAL_NAME.description", example = "Container Terminal")
     ...
     */
    @Schema(description = "property.PORT_ID.description", example = "1")
     ...
     */
    @Schema(description = "property.PORT_NAME.description", example = "PIRAEUS")
     ...
     */
    @Schema(description = "property.PORT_UNLOCODE.description", example = "GRPIR")
     ...
     */
    @Schema(description = "property.PORT_COUNTRY_CODE.description", example = "GR")
     ...
     */
    @Schema(description = "property.DESTINATION_ID.description", example = "1")
     ...
     */
    @Schema(description = "property.DESTINATION.description", example = "PIRAEUS")
