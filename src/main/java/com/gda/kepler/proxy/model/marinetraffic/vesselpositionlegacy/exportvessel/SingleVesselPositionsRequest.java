...
public class SingleVesselPositionsRequest {
     ...
     */
    @Schema(description = "The maximum age, in minutes, of the returned positions.", defaultValue = "2", maximum = "2880")
 ...
 * * extended If used with the value <b>extended</b>, the response includes scheduled static and voyage related vessel data report (AIS Message 5). In this case your request frequency might be limited (depending on your service terms) If omitted, the returned records include only position reports (AIS Messages 1, 2, 3/ 18, 19)
     */
    @Schema(description = "Resolution of the response. Available values: * simple * extended If used with the value extended, the response includes scheduled static and voyage related vessel data report (AIS Message 5). In this case your request frequency might be limited (depending on your service terms) If omitted, the returned records include only position reports (AIS Messages 1, 2, 3/ 18, 19)", defaultValue = "simple", allowableValues = {"extended", "simple"})
