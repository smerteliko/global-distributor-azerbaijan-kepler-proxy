...
public class VesselPositionsInADynamicBoundingBoxFullResponse extends BaseExportVesselsResponse {
     ...
     */
    @Schema(description = "The Name of the Last Port the vessel has visited", example = "PIRAEUS")
     ...
     */
    @Schema(description = "The Date and Time (in UTC) that the subject vessel departed from the Last Port", example = "2020-07-31T08:56:00.000Z")
     ...
     */
    @Schema(description = "A uniquely assigned ID by MarineTraffic for the Last Port", example = "1")
     ...
     */
    @Schema(description = "A uniquely assigned ID by United Nations for the Last Port", example = "GRPIR")
     ...
     */
    @Schema(description = "The Estimated Time of Arrival to Destination of the subject vessel according to the MarineTraffic calculations", example = "2020-10-14T17:00:00.000Z")
     ...
     */
    @Schema(description = "The date and time (in UTC) that the ETA was calculated by MarineTraffic", example = "2020-10-14T05:59:00.000Z")
     ...
     */
    @Schema(description = "The Distance (in NM) that the subject vessel has travelled since departing from Last Port", example = "3156")
     ...
     */
    @Schema(description = "The average speed calculated for the subject vessel during the latest voyage (port to port)", example = "6")
     ...
     */
    @Schema(description = "The maximum speed reported by the subject vessel during the latest voyage (port to port)", example = "6.7")
