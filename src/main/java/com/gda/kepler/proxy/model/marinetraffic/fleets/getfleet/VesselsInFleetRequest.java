...
public class VesselsInFleetRequest {
     ...
     */
    @Schema(description = "If used, will return specific fleet otherwise default fleet is used")
     ...
     */
    @Schema(description = "Specifies the number of the results page to return. Use this parameter to navigate through paginated results (with version 2) when the fleet contains more than 100 vessels.")
    @JsonProperty("page")
