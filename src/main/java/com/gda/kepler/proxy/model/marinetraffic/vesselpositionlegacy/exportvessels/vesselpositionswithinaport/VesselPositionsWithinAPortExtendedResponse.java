...
public class VesselPositionsWithinAPortExtendedResponse extends BaseExportVesselsResponse {
     ...
     */
    @Schema(description = "property.SHIPNAME.description", example = "IJVEER 52")
     ...
     */
    @Schema(description = "property.CALLSIGN.description", example = "PH2792")
     ...
     */
    @Schema(description = "property.LENGTH.description", example = "28.6")
    @JsonProperty("LENGTH")
     ...
     */
    @Schema(description = "property.WIDTH.description", example = "9")
    @JsonProperty("WIDTH")
     ...
     */
    @Schema(description = "property.DRAUGHT.description", example = "24")
     ...
     */
    @Schema(description = "property.DESTINATION.description", example = "")
     ...
     */
    @Schema(description = "property.ETA.description", example = "")
    @JsonProperty("ETA")
