...
public class BaseVoyageForecastResponse {
     ...
     */
    @Schema(description = "A uniquely assigned ID by MarineTraffic for the subject vessel", example = "371681")
     ...
     */
    @Schema(description = "The Destination of the subject vessel according to the AIS transmissions", example = "TORQUAY")
     ...
     */
    @Schema(description = "A uniquely assigned ID by MarineTraffic for the Last Port", example = "106")
     ...
     */
    @Schema(description = "The Name of the Last Port the vessel has visited", example = "SOUTHAMPTON")
     ...
     */
    @Schema(description = "A uniquely assigned ID by United Nations for the Last Port", example = "GBSOU")
     ...
     */
    @Schema(description = "The Date and Time (in UTC) that the subject vessel departed from the Last Port", example = "2020-10-14T17:00:00.000Z")
     ...
     */
    @Schema(description = "A uniquely assigned ID by MarineTraffic for the Next Port", example = "10379")
     ...
     */
    @Schema(description = "The Name of the Next Port as derived by MarineTraffic based on the subject vessel's reported Destination", example = "TORQUAY")
     ...
     */
    @Schema(description = "A uniquely assigned ID by United Nations for the Next Port", example = "GBTOR")
     ...
     */
    @Schema(description = "The Estimated Time of Arrival to Destination of the subject vessel according to the AIS transmissions", example = "2020-10-14T13:00:00.000Z")
    @JsonProperty("ETA")
