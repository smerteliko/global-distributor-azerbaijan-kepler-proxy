...
public class VesselEtaToPortExtendedResponse extends BaseVesselEtaToPortResponse {
     ...
     */
    @Schema(description = "property.SPEED_CALC.description", example = "58")
     ...
     */
    @Schema(description = "property.DRAUGHT_MAX.description", example = "104")
     ...
     */
    @Schema(description = "property.LOAD_STATUS_NAME.description", example = "LADEN")
     ...
     */
    @Schema(description = "property.ETD_CALC.description", example = "2020-11-26T16:20:14.000Z")
