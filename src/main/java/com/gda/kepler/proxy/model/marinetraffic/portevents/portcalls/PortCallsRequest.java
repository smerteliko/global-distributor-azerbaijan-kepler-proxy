...
@Schema(description = "Request parameters for: Port Calls")
public class PortCallsRequest {
     ...
     */
    @Schema(description = "Use 0 to only receive arrivals or 1 to only receive departures. If not used, the response will include both")
