...
public class VesselPositionsWithinAPortFullResponse extends BaseExportVesselsResponse {
     ...
     */
    @Schema(description = "property.SHIPNAME.description", example = "WABO")
     ...
     */
    @Schema(description = "property.SHIPTYPE.description", example = "70")
     ...
     */
    @Schema(description = "property.CALLSIGN.description", example = "PE6642")
     ...
     */
    @Schema(description = "property.LENGTH.description", example = "46")
    @JsonProperty("LENGTH")
     ...
     */
    @Schema(description = "property.WIDTH.description", example = "6")
    @JsonProperty("WIDTH")
     ...
     */
    @Schema(description = "property.GRT.description", example = "")
    @JsonProperty("GRT")
    private String grt;
     ...
     */
    @Schema(description = "property.DRAUGHT.description", example = "26")
     ...
     */
    @Schema(description = "property.TYPE_NAME.description", example = "Inland, Bunkership")
     ...
     */
    @Schema(description = "property.DESTINATION.description", example = "AMSTERDAM")
     ...
     */
    @Schema(description = "property.ETA.description", example = "2021-02-09T00:00:00.000Z")
    @JsonProperty("ETA")
     ...
     */
    @Schema(description = "property.CURRENT_PORT.description", example = "AMSTERDAM")
     ...
     */
    @Schema(description = "property.LAST_PORT.description", example = "ZAANDAM")
     ...
     */
    @Schema(description = "property.LAST_PORT_TIME.description", example = "2020-08-09T10:27:00.000Z")
     ...
     */
    @Schema(description = "property.CURRENT_PORT_UNLOCODE.description", example = "NLAMS")
     ...
     */
    @Schema(description = "property.CURRENT_PORT_COUNTRY.description", example = "NL")
     ...
     */
    @Schema(description = "property.LAST_PORT_ID.description", example = "2141")
     ...
     */
    @Schema(description = "property.LAST_PORT_UNLOCODE.description", example = "NLZAA")
     ...
     */
    @Schema(description = "property.LAST_PORT_COUNTRY.description", example = "NL")
     ...
     */
    @Schema(description = "property.NEXT_PORT_ID.description", example = "1766")
     ...
     */
    @Schema(description = "property.NEXT_PORT_NAME.description", example = "AMSTERDAM")
     ...
     */
    @Schema(description = "property.NEXT_PORT_COUNTRY.description", example = "NL")
     ...
     */
    @Schema(description = "property.DISTANCE_TRAVELLED.description", example = "54")
     ...
     */
    @Schema(description = "property.AVG_SPEED.description", example = "6.4")
     ...
     */
    @Schema(description = "property.MAX_SPEED.description", example = "6.8")
