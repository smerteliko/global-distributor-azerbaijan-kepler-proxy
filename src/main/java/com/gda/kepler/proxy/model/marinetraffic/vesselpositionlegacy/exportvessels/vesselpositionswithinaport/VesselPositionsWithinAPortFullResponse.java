...
public class VesselPositionsWithinAPortFullResponse extends BaseExportVesselsResponse {

    /**
     * The Shipname of the subject vessel
     */
    @Schema(description = "The Shipname of the subject vessel", example = "WABO")
     ...
     */
    @Schema(description = "The Shiptype of the subject vessel according to AIS transmissions", example = "70")
     ...
     */
    @Schema(description = "A uniquely designated identifier for the vessel's transmitter station", example = "PE6642")
     ...
     */
    @Schema(description = "The overall Length (in metres) of the subject vessel", example = "46")
    @JsonProperty("LENGTH")
     ...
     */
    @Schema(description = "The Breadth (in metres) of the subject vessel", example = "6")
    @JsonProperty("WIDTH")
     ...
     */
    @Schema(description = "The Draught (in metres x10) of the subject vessel according to the AIS transmissions", example = "26")
     ...
     */
    @Schema(description = "The Type of the subject vessel", example = "Inland, Bunkership")
     ...
     */
    @Schema(description = "The Destination of the subject vessel according to the AIS transmissions", example = "AMSTERDAM")
     ...
     */
    @Schema(description = "The Estimated Time of Arrival to Destination of the subject vessel according to the AIS transmissions", example = "2021-02-09T00:00:00.000Z")
    @JsonProperty("ETA")
     ...
     */
    @Schema(description = "The name of the Port the subject vessel is currently in (NULL if the vessel is underway)", example = "AMSTERDAM")
     ...
     */
    @Schema(description = "The Name of the Last Port the vessel has visited", example = "ZAANDAM")
     ...
     */
    @Schema(description = "The Date and Time (in UTC) that the subject vessel departed from the Last Port", example = "2020-08-09T10:27:00.000Z")
     ...
     */
    @Schema(description = "A uniquely assigned ID by United Nations for the Current Port", example = "NLAMS")
     ...
     */
    @Schema(description = "The Country that the Current Port is located at", example = "NL")
     ...
     */
    @Schema(description = "A uniquely assigned ID by MarineTraffic for the Last Port", example = "2141")
     ...
     */
    @Schema(description = "A uniquely assigned ID by United Nations for the Last Port", example = "NLZAA")
     ...
     */
    @Schema(description = "The Country that the Last Port is located at", example = "NL")
     ...
     */
    @Schema(description = "A uniquely assigned ID by MarineTraffic for the Next Port", example = "1766")
     ...
     */
    @Schema(description = "The Name of the Next Port as derived by MarineTraffic based on the subject vessel's reported Destination", example = "AMSTERDAM")
     ...
     */
    @Schema(description = "The Country that the Next Port is located at", example = "NL")
     ...
     */
    @Schema(description = "The Distance (in NM) that the subject vessel has travelled since departing from Last Port", example = "54")
     ...
     */
    @Schema(description = "The average speed calculated for the subject vessel during the latest voyage (port to port)", example = "6.4")
     ...
     */
    @Schema(description = "The maximum speed reported by the subject vessel during the latest voyage (port to port)", example = "6.8")
