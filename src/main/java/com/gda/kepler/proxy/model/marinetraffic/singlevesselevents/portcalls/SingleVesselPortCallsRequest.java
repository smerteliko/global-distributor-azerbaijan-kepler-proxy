 ...
 * * extended If used with the value <b>extended</b>, the response includes voyage related data since the previous port call
     */
    @Schema(description = "Resolution of the response. Available values: * simple * extended If used with the value extended, the response includes voyage related data since the previous port call", defaultValue = "simple", allowableValues = {"extended", "simple"})
