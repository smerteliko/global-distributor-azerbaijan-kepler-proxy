...
/**
 * Particular DTO representing refinery details from the /unit-runs endpoint.
 * This DTO mirrors the structure of the successful response (200) from the Kepler API.
 */
@Data
@Schema(description = "Refinery details retrieved from the /unit-runs API" )
final public class UnitRunsModel extends BaseDateSplitOutputModel {
}
