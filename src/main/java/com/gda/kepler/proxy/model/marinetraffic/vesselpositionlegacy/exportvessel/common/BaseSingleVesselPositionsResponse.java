...
public class BaseSingleVesselPositionsResponse {
     ...
     */
    @Schema(description = "property.LAT.description", example = "50.510560")
    @JsonProperty("LAT")
    private String lat;
     ...
     */
    @Schema(description = "property.LON.description", example = "-3.452753")
    @JsonProperty("LON")
    private String lon;
     ...
     */
    @Schema(description = "property.HEADING.description", example = "347")
     ...
     */
    @Schema(description = "property.COURSE.description", example = "321")
    @JsonProperty("COURSE")
     ...
     */
    @Schema(description = "property.STATUS.description", example = "1")
    @JsonProperty("STATUS")
     ...
     */
    @Schema(description = "property.TIMESTAMP.description", example = "2020-10-13T12:21:16.000Z")
