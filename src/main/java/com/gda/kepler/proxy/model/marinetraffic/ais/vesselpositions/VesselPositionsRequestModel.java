package com.gda.kepler.proxy.model.marinetraffic.ais.vesselpositions;
...
public class VesselPositionsRequestModel {

    /**
     * Service version. Mandatory, defaults to 9. (v_MTA030AD_1)
     */
    @Schema(description = "{v.mta030ad1.description}", requiredMode = Schema.RequiredMode.REQUIRED, defaultValue = "9", example = "9")
    @NotNull(message = "{validation.vessel.id.required}")
    private final Integer v = 9;
    ...
    public VesselPositionsRequestModel() {
    }

    @Builder
    public VesselPositionsRequestModel(String vesseltypeid, Integer timespan, String cursor, Integer limit, String protocol) {
