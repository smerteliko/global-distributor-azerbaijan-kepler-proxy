package com.gda.kepler.proxy.model.marinetraffic.singlevesselevents.portcalls.common;
...
@Schema(description = "Portcalls base")
public class BaseSingleVesselPortCallsResponse {
    /**
     * A uniquely assigned ID by MarineTraffic for the subject vessel
     */
    @Schema(description = "property.SHIP_ID.description", example = "3351323")
     ...
     */
    @Schema(description = "property.MMSI.description", example = "244770588")
    @JsonProperty("MMSI")
    private String mmsi;
     ...
     */
    @Schema(description = "property.SHIPNAME.description", example = "PIETERNELLA")
     ...
     */
    @Schema(description = "property.TIMESTAMP_LT.description", example = "2020-10-20T12:15:00.000Z")
     ...
     */
    @Schema(description = "property.TIMESTAMP_UTC.description", example = "2020-10-20T10:15:00.000Z")
     ...
     */
    @Schema(description = "property.MOVE_TYPE.description", example = "0")
     ...
     */
    @Schema(description = "property.TYPE_NAME.description", example = "Inland, Unknown")
     ...
     */
    @Schema(description = "property.PORT_NAME.description", example = "AMSTERDAM")
     ...
     */
    @Schema(description = "property.PORT_COUNTRY_CODE.description", example = "")
     ...
     */
    @Schema(description = "property.PORT_UNLOCODE.description", example = "NLAMS")
