package com.gda.kepler.proxy.model.marinetraffic.vesselpositionlegacy.exportvessels.vesselpositionsofadynamicfleet;
...
public class VesselPositionsOfADynamicFleetFullResponse extends BaseExportVesselsResponse {
    /**
     ...
     */
    @Schema(description = "The Name of the Last Port the vessel has visited", example = "KARLOVASI")
     ...
     */
    @Schema(description = "The Date and Time (in UTC) that the subject vessel departed from the Last Port", example = "2020-10-15T11:14:00.000Z")
     ...
     */
    @Schema(description = "A uniquely assigned ID by MarineTraffic for the Last Port", example = "44")
     ...
     */
    @Schema(description = "A uniquely assigned ID by United Nations for the Last Port", example = "GRKAR")
     ...
     */
    @Schema(description = "A uniquely assigned ID by MarineTraffic for the Next Port", example = "17305")
     ...
     */
    @Schema(description = "The Name of the Next Port as derived by MarineTraffic based on the subject vessel's reported Destination", example = "FOURNI")
     ...
     */
    @Schema(description = "The Estimated Time of Arrival to Destination of the subject vessel according to the MarineTraffic calculations", example = "2020-10-15T12:04:00.000Z")
     ...
     */
    @Schema(description = "The date and time (in UTC) that the ETA was calculated by MarineTraffic", example = "2020-10-15T11:42:00.000Z")
     ...
     */
    @Schema(description = "The Remaining Distance (in NM) for the subject vessel to reach the reported Destination", example = "7")
     ...
     */
    @Schema(description = "The Distance (in NM) that the subject vessel has travelled since departing from Last Port", example = "11")
     ...
     */
    @Schema(description = "The average speed calculated for the subject vessel during the latest voyage (port to port)", example = "22.6")
     ...
     */
    @Schema(description = "The maximum speed reported by the subject vessel during the latest voyage (port to port)", example = "23.1")
